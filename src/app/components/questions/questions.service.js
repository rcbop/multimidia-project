  ...
  function questionsService() {
    ...
    var questions = [
      ...
      alts: [
        ...
        { label: 'Elastic Compute Cloud.', value: 2 },
      ...
      { id: 2,
        ...
        correct: 1,
      alts: [
        { label: 'Reduz significativamente o tempo para escalar um serviço.', value: 1 },
      ...
      alts: [
        ...
        { label: 'Sob demanda, reservas por capacidade, preço variável por "spot"', value: 3 },
      ...
      alts: [
        ...
        { label: 'Elastic Block Store', value: 3 },
